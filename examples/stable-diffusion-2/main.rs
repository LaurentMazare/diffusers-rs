...
use clap::Parser;
use diffusers::pipelines::stable_diffusion::v2_1 as stable_diffusion;
...
struct Args {
    ...
    #[arg(long, value_name = "FILE", default_value = "data/unet_v2.1.ot")]
    unet_weights: String,

    /// The CLIP weight file, in .ot format.
    #[arg(long, value_name = "FILE", default_value = "data/clip_v2.1.ot")]
    clip_weights: String,

    /// The VAE weight file, in .ot format.
    #[arg(long, value_name = "FILE", default_value = "data/vae_v2.1.ot")]
    vae_weights: String,
